...
public class RemoverColaboradorListaCasoDeUso {

	private final ListaRepositorio listaRepositorio;
	private final ListaServico listaServico;

	public RemoverColaboradorListaCasoDeUso(ListaRepositorio listaRepositorio, ListaServico listaServico) {
		this.listaRepositorio = listaRepositorio;
		this.listaServico = listaServico;
	}

	public void executar(RemoverColaboradorListaComando comando) {
		ListaId listaId = new ListaId(comando.listaId());
		UsuarioId donoId = new UsuarioId(comando.donoId());
		UsuarioId colaboradorId = new UsuarioId(comando.colaboradorId());
		...
		listaServico.removerColaborador(lista, donoId, colaboradorId);
	}
}
