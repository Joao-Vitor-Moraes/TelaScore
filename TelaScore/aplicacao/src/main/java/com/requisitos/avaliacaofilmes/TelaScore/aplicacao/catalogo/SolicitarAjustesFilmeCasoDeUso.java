...
public class SolicitarAjustesFilmeCasoDeUso {
	...
	public void executar(SolicitarAjustesFilmeComando comando) {
		...
		solicitacaoServico.solicitarAjustes(solicitacao, avaliador, comando.feedback());
	}
}
