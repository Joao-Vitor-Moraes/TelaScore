...
Funcionalidade: Envio de recomendações sociais
  ...
  Quero recomendar filmes e quizzes para meus amigos
  Para compartilhar obras e desafios que eu gostei
  ...
  Cenário: Enviar uma recomendação válida de Quiz para um amigo
    Dado que o usuário remetente com ID 1 quer recomendar o quiz "QUIZ-005"
    Quando ele envia a recomendação para o destinatário com ID 2 com a mensagem "Tente bater minha pontuação!"
    Então a recomendação deve ser criada com sucesso
    E o status inicial da recomendação deve ser "PENDENTE"